...
<div class="progress progress-bar-custom-alt progress-sm m-b-0">
    <div class="progress-bar progress-bar-custom progress-bar-striped active" role="progressbar" aria-valuenow="91"
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <div class="home-wrapper">
                    ...
                    <h1 class="home-text text-uppercase text-custom">Goodbye!</h1>
                    <a href="index.php" style="text-decoration:underline" class="text-muted">Click to go to
                        Dashboard</a>
                </div>
