...
<head>
    ...
    <!-- App title -->
    <title>Ammanistrazione - Info</title>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li>
                        <h4 class="page-title">Amministrazione - Info</h4>
                    </li>
                </ul>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="amministrazione.php" class="waves-effect active"><i
                                    class="zmdi zmdi zmdi-settings"></i> <span> Amministator - Info </span> </a>
                    </li>
